...
export default class TaskCrud extends Component {
    ...
    save(taskDB) {
        ...
        const url = taskDB.id ? `${Constants.baseUrl}/${taskDB.id}` : Constants.baseUrl
    ...
    toggleCheck(task) {
        axios.put(Constants.baseUrl + '/' + task.id, {
            title: task.title,
    ...
    remove(task) {
        axios.delete(`${Constants.baseUrl}/${task.id}`)
            .then(resp => {
            ...
            .map(task => {
                return (
                    <div className="div-row" key={task.id}>
                        <Checkbox 
                            task={task}
                            handleChange={() => this.toggleCheck(task)}
                        />
                        {/* STILL NOT WORKING */}
                        {/* <Checkbox 
                            task={task}
            ...
            <div className="div-row" id="first-row">
                    ...
                    <div className="div-btns">
                        <button className="btn" 
                            onClick={e => this.save(this.state.task)}>
